...
#   3. 加入 crontab：
#        0 3 * * * /data/krond/scripts/databackup_cron.sh
#   或指定计划：
#        0 3 * * * /data/krond/scripts/databackup_cron.sh schedule_id1 schedule_id2
# ============================================================

LOG_FILE="/data/krond/scripts/logs/databackup.log"
